...
/**
 * Created by fanqilong on 2017/10/31.
 */
...
public class RegUtil {
     ...
     * @return
     */
    public static boolean isReferee(String referee) {
        Pattern pattern = Pattern.compile("^\\d{0,8}$");
        Matcher m = pattern.matcher(referee);
        return m.matches();
    }
    ...
    public static boolean isMatch(String regex, String string) {
        return !StrUtil.isEmpty(string) && Pattern.matches(regex, string);
    }
