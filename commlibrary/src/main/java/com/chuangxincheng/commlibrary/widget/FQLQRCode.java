...
/**
 * @author  by fanqilong on 2017/2/17.
 * 生成二维码
 */

public class FQLQRCode {

    /**
     * 获取建造者
     *
     * @param text 样式字符串文本
     * @return {@link FQLQRCode.Builder}
     */
    public static FQLQRCode.Builder builder(@NonNull CharSequence text) {
        return new FQLQRCode.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = FQLQRCode.creatQRCode(content, codeSide, codeSide, backgroundColor, codeColor);
            if (imageView != null) {
