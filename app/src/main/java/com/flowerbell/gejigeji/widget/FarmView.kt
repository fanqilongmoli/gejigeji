 ...
 */
class FarmView(context: Context?, attrs: AttributeSet?) : LinearLayout(context, attrs), View.OnClickListener {

    private var feedListener: FeedListener? = null

    fun setFeedListener(lis: FeedListener) {
        feedListener = lis
    }
